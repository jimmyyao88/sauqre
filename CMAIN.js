function CMain(oData) {
    ...
    this._initSounds = function () {
        ...
        aSoundsInfo.push({path: './sounds/',filename:'boing_wall',loop:false,volume:1, ingamename: 'boing_wall'});        
        aSoundsInfo.push({path: './sounds/',filename:'bonus_balls',loop:false,volume:1, ingamename: 'bonus_balls'});
    ...
    _oData = oData;
    STARTING_BALLS = oData.starting_balls;
    EXTRA_BALLS = oData.extra_balls;
    BONUS_VALUE = oData.bonus_value;
